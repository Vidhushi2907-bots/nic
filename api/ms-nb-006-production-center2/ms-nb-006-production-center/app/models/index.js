...
// discard tag
db.discardTagsModel = require('./discard_tags.model.js')(sequelize, Sequelize);
db.discardRequestedTagsModel = require('./discard_requested_tags.model.js')(sequelize, Sequelize);
...
db.replicaModel=require('./replica.model')(sequelize, Sequelize);
db.selfPlantObservationModel=require('./self_plant_observation.model')(sequelize, Sequelize);
db.offTypeObservationModel=require('./off_type_observation.model')(sequelize, Sequelize);
db.summaryObservationModel=require('./summary_observation.model')(sequelize, Sequelize);
db.bspProforma5asResponseModel=require('./bsp_proforma_5as_response.model')(sequelize, Sequelize);
db.bsp5GotMemberRelationModel=require('./bsp5_got_member_relation.model')(sequelize, Sequelize);
...
db.monitoringTeamOfBspcPlots= require('./monitoring_team_of_bspc_plots.model.js')(sequelize, Sequelize);

// new model add
db.processedSeedDetailsBkpsModel = require('./processed_seed_details_bkps.js')(sequelize, Sequelize);
db.seedForProcessedStackBkpsModel = require('./seed_for_processed_stack_bkps.js')(sequelize, Sequelize);
db.seedProcessingRegisterBkpsModel = require('./seed_processing_register_bkps.js')(sequelize, Sequelize);
...
db.bsp5GotMemberRelationModel.belongsTo(db.gotMonitoringTeamsMemberModel, {
    foreignKey: 'got_member_id',
    targetKey: 'id'
});
...
db.bspProrforma2Model.belongsTo(db.bspProrforma3Model, {
    foreignKey: 'id',
...
db.seedInventory.belongsTo(db.directIndentModel, {
    foreignKey: 'variety_code',
    targetKey: 'variety_code',
    // as:'seed_for_production'
});
...
db.generateSampleForwardingLettersModel.belongsTo(db.seedProcessingRegister,{
    foreignKey: 'lot_no',
    targetKey: 'lot_no',
})

db.seedProcessingRegister.hasMany(db.investVerifyModel,{
    foreignKey: 'invest_verify_id',
    targetKey: 'id',
    as:'iv'
})
db.investVerifyModel.hasMany(db.investHarvestingModel,{
    foreignKey: 'invest_harvesting_id',
    targetKey: 'id',
    as:'ih'
...
db.seedTagRange.hasMany(db.seedTagDetails,{
    foreignKey: 'id',
    targetKey: 'seed_tag_details_id',
})
...
db.availabilityOfBreederSeedModel.belongsTo(db.bspPerformaBspOne, {
    foreignKey: 'user_id',
    targetKey:'user_id'
});
db.bspPerformaBspOne.belongsTo(db.availabilityOfBreederSeedModel, {
    foreignKey: 'user_id',
    targetKey:'user_id'
});
db.bspProformaOneBspc.belongsTo(db.availabilityOfBreederSeedModel, {
    foreignKey: 'bspc_id',
    targetKey:'user_id'
});
db.availabilityOfBreederSeedModel.belongsTo(db.bspProformaOneBspc, {
    foreignKey: 'user_id',
    targetKey:'bspc_id'
});
...
db.generateSampleForwardingLettersModel.belongsTo(db.userModel, {
    foreignKey: 'got_bspc_id',
    targetKey: 'id',
})
db.bspPerestingsBspFiveModel.belongsTo(db.generateSampleForwardingLettersModel, {
    foreignKey: 'lot_num',
    targetKey: 'lot_no',
});

db.bspPerestingsBspFiveModel.belongsTo(db.gotTestingModel, {
    foreignKey: 'bspc_id',
    targetKey: 'bspc_id',
});

db.generateSampleForwardingLettersModel.belongsTo(db.bspPerestingsBspFiveModel, {
    foreignKey: 'lot_no',
    targetKey: 'lot_num',
});
db.bspPerestingsBspFiveModel.belongsTo(db.summaryObservationModel, {
    foreignKey: 'id',
    targetKey: 'bsp_5as_id',
})
db.bspPerestingsBspFiveModel.belongsTo(db.bspPerformaBspOne, {
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})

db.gotTestingModel.belongsTo(db.bspPerformaBspOne, {
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})

db.gotTestingModel.belongsTo(db.bspProrforma2Model, {
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})
...
// Define the relationship between gotTestingModel and bspPerformaBspOne
// db.gotTestingModel.belongsTo(db.bspPerformaBspOne, {
//     foreignKey: 'bspc_id', // Correct the foreign key here
//     targetKey: 'id', // The field in bspPerformaBspOne you're referencing
//     as: 'bsp_proforma_1' // Alias to distinguish the relationship
// });

// Define the relationship between gotTestingModel and bspProrforma2Model
// db.gotTestingModel.belongsTo(db.bspProrforma2Model, {
//     foreignKey: 'bsp_proforma_2_id', // Correct the foreign key here
//     targetKey: 'id', // The field in bspProrforma2Model you're referencing
//     as: 'bsp_proforma_2' // Alias to distinguish the relationship
// });
db.gotTestingModel.belongsTo(db.userModel, {
    foreignKey: 'user_id', // The foreign key in gotTestingModel
    targetKey: 'id', // The target key in userModel (the key you're referencing)
   // as: 'user' // Alias to distinguish the relationship
  });
  


db.bspPerestingsBspFiveModel.belongsTo(db.bspProrforma2Model, {
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})
...
db.bspProformaOneBspc.belongsTo(db.agencyDetailModel, {
    foreignKey: 'bspc_id',
    targetKey: 'user_id',
});
...
db.gotTestingModel.belongsTo(db.gotShowingDetailsModel, {
    foreignKey: 'id',
    targetKey: 'got_testing_id'
});
...
db.monitoringTeamOfBspc.belongsTo(db.bspPerformaBspTwo, {
    foreignKey: 'user_id',
    targetKey: 'user_id',
});
db.monitoringTeamOfBspc.belongsTo(db.monitoringTeamOfBspcPlots, {
    foreignKey: 'id',
    targetKey: 'monitoring_team_of_id',
});
db.inabilityReallocatesModel.belongsTo(db.carryOverSeedModel, {
    foreignKey: 'user_id',
    targetKey: 'user_id',
});
db.bspPerformaBspOne.belongsTo(db.seasonModel, {
    foreignKey: 'season',
    targetKey: 'season_code',
    // onDelete: 'cascade',
});
...
db.inabilityReallocatesModel.belongsTo(db.bspPerformaBspOne,{
    foreignKey: 'user_id',
    targetKey: 'user_id',
})
db.bspProformaOneBspc.belongsTo(db.carryOverSeedModel,{
    foreignKey: 'bspc_id',
    targetKey: 'user_id',
}),
db.directIndentModel.belongsTo(db.stateModel,{
...
db.directIndentModel.belongsTo(db.districtModel,{
    foreignKey: 'district_code',
    targetKey: 'district_code',
}),
db.directIndent.belongsTo(db.seedTagDetails, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});
db.directIndentModel.belongsTo(db.seedTagDetails, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});

db.directIndentModel.belongsTo(db.userModel, {
    foreignKey: 'user_id',
    targetKey: 'id'
});
db.directIndentModel.belongsTo(db.agencyDetailModel, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});
db.directIndentModel.belongsTo(db.liftingSeedDetailsModel, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});
db.indentOfBreederseedModel.belongsTo(db.liftingSeedDetailsModel, {
    foreignKey: 'user_id',
    targetKey: 'indentor_id'
});
db.seedTagDetails.belongsTo(db.indentOfBreederseedModel, {
    foreignKey: 'variety_code',
    targetKey: 'variety_code'
});

db.liftingSeedDetailsModel.belongsTo(db.seedTagDetails, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});
db.bspPerformaBspTwo.belongsTo(db.investHarvestingModel, {
    foreignKey: 'user_id',
    targetKey: 'user_id'
});
db.bspProrforma2Model.belongsTo(db.directIndentModel, {
    foreignKey: 'user_id',
    targetKey: 'user_id',
});
db.bspProrforma3Model.belongsTo(db.bspPerformaBspOne, {
    foreignKey: 'variety_code',
    targetKey: 'variety_code',
});
db.seedProcessingRegister.belongsTo(db.seedTagDetails,{
    foreignKey: 'lot_id',
    targetKey: 'lot_id',
})
// ends
db.bspPerformaBspThree.belongsTo(db.varietyModel, {
    foreignKey: 'variety_code',
    targetKey: 'variety_code',
});

// discard reletion
db.discardTagsModel.belongsTo(db.discardRequestedTagsModel,{
    foreignKey: 'id',
    targetKey: 'discard_id',
})

db.discardTagsModel.belongsTo(db.seasonModel,{
    foreignKey: 'season',
    targetKey: 'season_code',
})
db.discardTagsModel.belongsTo(db.cropModel,{
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})
db.discardTagsModel.belongsTo(db.varietyModel,{
    foreignKey: 'variety_code',
    targetKey: 'variety_code',
})
db.discardTagsModel.belongsTo(db.varietLineModel,{
    foreignKey: 'variety_line_code',
    targetKey: 'line_variety_code',
})


db.discardTagsModel.belongsTo(db.userModel,{
    foreignKey: 'user_id',
    targetKey: 'id',
})
db.discardTagsModel.belongsTo(db.seedTagDetails,{
    foreignKey: 'crop_code',
    targetKey: 'crop_code',
})
