...
module.exports = app => {
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-sample-sowing-crop`, auth, got.getGotSampleSowingCrop);
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-sample-sowing-year`, auth, got.getGotSamplesowingYear);
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-sample-sowing-season`, auth, got.getGotSampleSowingSeason);
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-sowing-details-consignment`, auth, got.getGotsowingDetailsConsignment);
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-monitoring-team-test-number`, auth, got.getGotMonitoringTeamTestNumber);
    app.get(`${process.env.MICRO_SERVICE}/api/sync-got-inspection-data`, got.syncGotInspectionData);

    app.post(`${process.env.MICRO_SERVICE}/api/get-got-user-team-data`, auth, got.createGOTUserforMonitoring);
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-test-inspection-data`, auth, got.getInspectionuser);
