...
module.exports = app => {
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-monitoring-team-plots-data`,auth,monitoringTeamDetails.getMonitoringTeamPlotsData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-assigned-team-all-data-national`,auth,monitoringTeamDetails.getAssignedTeamAllDataNational);
    

    // generate tag for Potato
    app.post(`${process.env.MICRO_SERVICE}/api/update-generate-tag-lot-data`,auth,monitoringTeamDetails.updateGenerateTagLotData);
