...
module.exports = app => {
        ...
        app.post(`${process.env.MICRO_SERVICE}/api/stl-report/generate-pdf`, auth, stlForms.generateStlReportPdf);

    
    app.get(`${process.env.MICRO_SERVICE}/api/stl-report/view/:fileName`, stlForms.viewStlReportPdf);
    app.post(`${process.env.MICRO_SERVICE}/api/stl-report/generate-pdf`, auth, stlForms.generateStlReportPdf);
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-check-running-no`,auth, stlForms.checkRunningNumber);
    

    // stl reports status apis
    app.post(`${process.env.MICRO_SERVICE}/api/public-get-stl-report-status-data`, stlForms.getStlReportStatusData);
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/update-stl-report-status-data`, auth,stlForms.updateStlReportStatusData);
     ...
     app.post(`${process.env.MICRO_SERVICE}/api/get-got-details-report`,auth,stlForms.getGotReportDetailsBspc);
    app.post(`${process.env.MICRO_SERVICE}/api/get-got-variety`,auth,stlForms.getGotreportVariety);
     ...
     app.post(`${process.env.MICRO_SERVICE}/api/get-got-report-details-byid`,auth,stlForms.getGotReportDetailsForDownload);
     app.post(`${process.env.MICRO_SERVICE}/api/get-got-report-details-byid-Qr`,stlForms.getGotReportDetailsForDownloadForQr);

     app.post(`${process.env.MICRO_SERVICE}/api/get-got-year-report`,auth,stlForms.getGotbspfiveyearreport);
     app.post(`${process.env.MICRO_SERVICE}/api/get-got-season-report`,auth,stlForms.getGotbspfiveSeasonReport);
     app.post(`${process.env.MICRO_SERVICE}/api/get-got-crop-report`,auth,stlForms.getGotCropReport);
