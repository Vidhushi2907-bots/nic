...
module.exports = app => {
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-surplus-indent-lot-number`,auth, tagPrint.getSurplusIndentLotNumber);
    ...
    // for disacard tag
    app.post(`${process.env.MICRO_SERVICE}/api/add-disacrd-tag-data`,auth, tagPrint.addDisacrdTagData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-discard-tag-data`,auth, tagPrint.getDiscardTagData);
    app.post(`${process.env.MICRO_SERVICE}/api/delete-discard-tag-data`,auth, tagPrint.deleteDiscardTagData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-discard-tag-no-list-data`,auth, tagPrint.getDiscardTagNoListData);

    app.post(`${process.env.MICRO_SERVICE}/api/get-discard-tag-variety`, tagPrint.getDiscardTagVariety);
    app.post(`${process.env.MICRO_SERVICE}/api/get-approved-tag-spp-data`, tagPrint.getApprovedTagSPPData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-approved-tag-no-data`,tagPrint.getApprovedTagNoData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-approved-lot-no-data`, tagPrint.getApprovedlotNoData);
