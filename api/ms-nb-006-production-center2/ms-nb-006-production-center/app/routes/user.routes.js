...
module.exports = app => {
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-bsp-proforma3-data-report`, auth, indentor.getBspProforma3DataReport);
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/check-existing-spa`, auth, indentor.checkExistingSpa);
    ...
    app.post(`${process.env.MICRO_SERVICE}/api/get-bill-print-data`, auth, processedSeed.getBillPrintData);
    app.post(`${process.env.MICRO_SERVICE}/api/get-bill-print-data1`, processedSeed.getBillPrintData);
    ...
    //CROP STATUS REPORT
    app.post(`${process.env.MICRO_SERVICE}/api/crop-status-reports`,auth, indentor.CropStatusReport);
    ...
    // intake-verification-register report
    app.post(`${process.env.MICRO_SERVICE}/api/get-intake-verification-register-status-reports`, auth, indentor.getIntakeVerificationRegisterStatusReports);

    // update bag size
    app.post(`${process.env.MICRO_SERVICE}/api/update-bag-size-data`, users.updateBagSizeData);



    //lifting total varities 
    
    app.post(`${process.env.MICRO_SERVICE}/api/get-lifting-total-variety`, auth, users.getVarietycount);
    app.post(`${process.env.MICRO_SERVICE}/api/get-lifting-total-production`, auth, users.gettotalproduction); 
    app.post(`${process.env.MICRO_SERVICE}/api/get-total-lifting`, auth, users.gettotallifting); 
