...
import { checkAlphabet, checkDecimalValueTwoPlace, checkLength, checkNumber, convertDates, convertDatetoDDMMYYYYwithdash } from 'src/app/_helpers/utility';
import Swal from 'sweetalert2';

@Component({
  selector: 'app-variety-characterstic-reports-view-form',
  templateUrl: './variety-characterstic-reports-view-form.component.html',
  styleUrls: ['./variety-characterstic-reports-view-form.component.css']
})
export class VarietyCharactersticReportsViewFormComponent  extends ngbDropdownEvents implements OnInit {
   ...
   filterCropData(newValue) {
     ...
     if (result &&  result[0] && result[0].is_notified) {
   ...
   getPageData(loadPageNumberData: number = 1, searchData: any | undefined = undefined) {
     this.service.postRequestCreator("data-characterstics-list", null, {
       ...
       if (apiResponse !== undefined
         ...
         this.getListData(this.allData && this.allData[0],null,null);
       }
     });
   }
   ...
   getListData(data,dataIndex:any,pageNo:any) {
     ...
     this.ngForm.controls["spacing_from"].patchValue( this.apiResponseData && this.apiResponseData.m_variety_characteristic && this.apiResponseData.m_variety_characteristic['spacing_from'] ? this.apiResponseData.m_variety_characteristic['spacing_from'] : '');
 
     this.ngForm.controls["spacing_to"].patchValue( this.apiResponseData && this.apiResponseData.m_variety_characteristic && this.apiResponseData.m_variety_characteristic['spacing_to'] ? this.apiResponseData.m_variety_characteristic['spacing_to'] : '');
     ...
     this.ngForm.controls['insitution'].patchValue(this.apiResponseData && this.apiResponseData.m_variety_characteristic && this.apiResponseData.m_variety_characteristic['responsible_insitution_for_breeder_see'] ? this.apiResponseData.m_variety_characteristic['responsible_insitution_for_breeder_see'] : '');
