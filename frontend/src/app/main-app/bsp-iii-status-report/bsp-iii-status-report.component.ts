...
@Component({
  selector: 'app-bsp-iii-status-report',
  templateUrl: './bsp-iii-status-report.component.html',
  styleUrls: ['./bsp-iii-status-report.component.css']
})
export class BspIIIStatusReportComponent implements OnInit {  
  ...
  getPageData(loadPageNumberData: number = 1, searchData: any | undefined = undefined) {
    ...
    this.productioncenter.postRequestCreator("bsp-three-status-reports", filters, null)
