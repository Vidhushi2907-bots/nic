...
@Component({
  selector: 'app-profarma-one-qr',
  templateUrl: './profarma-one-qr.component.html',
  styleUrls: ['./profarma-one-qr.component.css']
})
export class ProfarmaOneQrComponent implements OnInit {
  ...
  //         console.log('Decoded Report:', this.reportData);
  //         console.log('Decoded Table:', this.tableData);
