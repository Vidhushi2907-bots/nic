...
import { VarietyCharactersticViewFormComponent } from '../variety-characterstic-view-form/variety-characterstic-view-form.component';
@Component({
...
export class VarietyCharactersticReportsComponent implements OnInit {
  ...
  @ViewChild(VarietyCharactersticViewFormComponent) VarietyCharactersticViewFormComponent:  VarietyCharactersticViewFormComponent| undefined = undefined;
...
async getCropNameList(newValue: string) {
  ...
  updatePaginatedData(): void {
    ...
    this.VarietyCharactersticViewFormComponent.getListData(this.paginatedData[0],null,this.loadpageNo);
  }
  ...
  nextPage() {
    // if (this.currentPage * this.pageSize < this.allData.length) {
      ...
      this.VarietyCharactersticViewFormComponent.nextPage();
    // }
  }
  ...
  previousPage() {
    // if (this.currentPage > 1) {
      this.currentPage--;
      // this.updatePaginatedData();
      this.VarietyCharactersticViewFormComponent.previousPage();
    // }
  }
...
getCroupCroupList(): Promise<any> {
  ...
  patchData(data,dataIndex) {
    ...
    this.VarietyCharactersticViewFormComponent.getListData(data,dataIndex,this.loadpageNo);
  }
  VarieyName(data) {
