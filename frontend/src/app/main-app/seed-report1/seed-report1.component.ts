...
@Component({
  selector: 'app-seed-report1',
  templateUrl: './seed-report1.component.html',
  styleUrls: ['./seed-report1.component.css']
})
export class SeedReport1Component implements OnInit {
reportData: any = {};
