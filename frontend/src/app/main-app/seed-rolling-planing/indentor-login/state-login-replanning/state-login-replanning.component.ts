  ...
  getPageData() {
    ...
    this['Login_Replanning'].forEach((variety) => {
      bspcArray.push(this.fb.group({
        ...
        willingness: [variety.willingness],
        tentative_breeder_seed_quantity1: [variety.tentative_breeder_seed_quantity1],
      ...
      bspcArray.push(
        this.fb.group({
          ...
          tentative_breeder_seed_qty_i: [
            item.tentative_breeder_seed_qty_i,
            // { value: item.tentative_breeder_seed_qty_i, disabled: false },
            [Validators.min(0)]
          ],
          replacement_variety_name: [
            item.replacement_variety_name
