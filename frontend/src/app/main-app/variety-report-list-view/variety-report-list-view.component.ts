...
@Component({
  selector: 'app-variety-report-list-view',
  templateUrl: './variety-report-list-view.component.html',
  styleUrls: ['./variety-report-list-view.component.css']
})
export class VarietyReportListViewComponent  extends ngbDropdownEvents implements OnInit {
